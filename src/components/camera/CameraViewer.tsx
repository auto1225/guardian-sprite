      ...
      <div className={`relative flex items-center justify-center ${
        ...
        {showConnecting && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50">
            ...
            <p className="text-white/50 text-xs mt-1">{t("cameraViewer.waitingForCamera", { device: t(`settings.${deviceType || "laptop"}`) })}</p>
          </div>
        )}
        ...
        {showWaiting && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50">
            ...
            <p className="text-white/70 text-sm mt-4">{t("cameraViewer.waitingForStart", { device: t(`settings.${deviceType || "laptop"}`) })}</p>
          </div>
        )}
