    ...
    <div className="fixed inset-0 bg-red-800/60 backdrop-blur-2xl z-50 flex flex-col overflow-hidden">
      ...
      {!isHistoryView && (
        <div className="p-4 shrink-0 space-y-3">
          {!phoneDismissed && (
            <button
              onClick={() => { stopAlertSound(); Alarm.addDismissed(alert.id); Alarm.suppressFor(5000); setPhoneDismissed(true); }}
          ...
          {onDismissRemoteAlarm && (
            <button
              onClick={() => { stopAlertSound(); Alarm.addDismissed(alert.id); Alarm.suppressFor(5000); onDismissRemoteAlarm(); onDismiss(); }}
